...
echo "${RED_TEXT}${BOLD_TEXT}[TASK 1] Creating Instance Groups...${RESET_FORMAT}"
...
echo ""
echo "${RED_TEXT}${BOLD_TEXT}[TASK 2] Creating Health Check...${RESET_FORMAT}"
...
echo ""
echo "${RED_TEXT}${BOLD_TEXT}[TASK 2] Reserving Static External IP...${RESET_FORMAT}"
...
echo ""
echo "${RED_TEXT}${BOLD_TEXT}[TASK 2] Creating Backend Service...${RESET_FORMAT}"
...
echo ""
echo "${RED_TEXT}${BOLD_TEXT}[TASK 2] Creating Target Pool & Forwarding Rule...${RESET_FORMAT}"
