...
prompt_input() {
    ...
    local prompt_text=$2
    local color=$3
    read -p "${color}${BOLD} ▶ ${prompt_text} ${RESET}: " $var_name
}

prompt_input "EVENT_NAME" "Enter EVENT_NAME" "${YELLOW}"
prompt_input "TABLE_NAME" "Enter TABLE_NAME" "${YELLOW}"
prompt_input "VALUE_X_1" "Enter VALUE_X_1" "${YELLOW}"
prompt_input "VALUE_Y_1" "Enter VALUE_Y_1" "${YELLOW}"
prompt_input "VALUE_X_2" "Enter VALUE_X_2" "${YELLOW}"
prompt_input "VALUE_Y_2" "Enter VALUE_Y_2" "${YELLOW}"
prompt_input "FUNCTION_1" "Enter FUNCTION_1" "${YELLOW}"
prompt_input "FUNCTION_2" "Enter FUNCTION_2" "${YELLOW}"
prompt_input "MODEL_NAME" "Enter MODEL_NAME" "${YELLOW}"
...
echo "${YELLOW}${BOLD}⚡ Loading datasets into BigQuery...${RESET}"
...
#TASK 4
echo "${YELLOW}${BOLD}⚡ Training BQML Logistic Regression Model (Task 4)...${RESET}"
...
#TASK 5
echo "${YELLOW}${BOLD}⚡ Running Predictions on World Cup Matches (Task 5)...${RESET}"
