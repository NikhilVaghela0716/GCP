...
```bash
curl -LO https://raw.githubusercontent.com/NikhilVaghela0716/GCP/main/Manage%20Cloud%20Storage%20Lifecycle%20Policy%20using%20gcloud%20storage/NikhilVaghela0716.sh
```
```bash
