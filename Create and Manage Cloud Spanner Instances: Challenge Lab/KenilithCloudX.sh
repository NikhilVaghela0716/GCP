...
curl -LO https://raw.githubusercontent.com/NikhilVaghela0716/GCP/main/Create%20and%20Manage%20Cloud%20Spanner%20Instances%3A%20Challenge%20Lab/Customer_List_500.csv
...
touch kenilith
gsutil cp kenilith gs://$DEVSHELL_PROJECT_ID/tmp/kenilith
...
gcloud dataflow jobs run kenilith \
