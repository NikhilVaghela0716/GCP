...
echo "${GREEN_TEXT}${BOLD_TEXT}        GOOGLE CLOUD LAB | NIKHIL VAGHELA            ${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}======================================================${RESET_FORMAT}"
echo
...
# Step 8: Query findings with retry
query_findings() {
...
echo "${GREEN_TEXT}${BOLD_TEXT}======================================================${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}${BOLD_TEXT}Thank you for learning with Nikhil Vaghela 🚀${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@Nikhil-Vaghela0716${RESET_FORMAT}"
echo
echo "Next steps:"
